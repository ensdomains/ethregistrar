...
contract('ETHRegistrarController', function (accounts) {
    ...
    it('should not allow a commitment with addr but not resolver', async () => {
        try {
            await controller.makeCommitmentWithConfig("newconfigname2", registrantAccount, secret, NULL_ADDRESS, registrantAccount)
        } catch (error) {
    ...
    it('should include the owner in the commitment', async () => {
        ...
        try {
            await controller.register("newname2", registrantAccount, 28 * DAYS, secret, {value: 28 * DAYS, gasPrice: 0})
        } catch (error) {
            return exceptions.ensureException(error);
        }
    ...
    it('should reject duplicate registrations', async () => {
        ...
        try {
            await controller.register("newname", registrantAccount, 28 * DAYS, secret, {value: 28 * DAYS, gasPrice: 0})
        } catch (error) {
            return exceptions.ensureException(error);
        }
